public class Animal {
    ...
    public void toRun() {
        ...
        if (this.run) {
            System.out.println(this.creature + " " + this.name + ": \"Я могу бежать\" ");
        } else {
    ...
    public void toFly() {
        ...
        if (this.fly) {
            System.out.println(this.creature + " " + this.name + ": \"Я могу летать\" ");
        } else {
            System.out.println(this.creature + " " + this.name + ": \"я НЕ могу летать\" ");
        }
    ...
    public void toSwim() {
        ...
        if (this.swim) {
            System.out.println(this.creature + " " + this.name + ": \"Я умею плавать\" ");
        } else {
            System.out.println(this.creature + " " + this.name + ": \"я НЕ умею плавать\" ");
        }
